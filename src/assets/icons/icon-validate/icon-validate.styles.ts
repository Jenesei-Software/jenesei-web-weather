...
export const IconValidateWrapperBigTrue = styled.div`
  ...
  background: ${(props) => props.theme.color.color.green['10']};
  & svg {
    width: 102px;
    height: 102px;
    & path {
      fill: ${(props) => props.theme.color.color.green['100']};
    }
  }
`

export const IconValidateWrapperBigFalse = styled(IconValidateWrapperBigTrue)`
  background: ${(props) => props.theme.color.color.red['10']};
  & svg {
    & path {
      fill: ${(props) => props.theme.color.color.red['100']};
    }
  }
`
